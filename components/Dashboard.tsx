    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <header className="border-b border-zinc-200 bg-white px-4 py-6 dark:border-zinc-800 dark:bg-zinc-900 sm:px-8">
        <div className="mx-auto flex max-w-5xl items-start justify-between gap-4">
          ...
          <Link
            href="/"
            className="hidden shrink-0 items-center gap-1 rounded-md border border-zinc-200 bg-white px-3 py-1.5 text-xs text-zinc-600 transition hover:border-rose-700/40 hover:text-rose-700 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:border-rose-400/40 dark:hover:text-rose-400 sm:inline-flex"
          >
            ← 查看官网首页
          </Link>
        </div>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-8">
        <div className="mb-4 flex items-baseline justify-between">
          ...
          <Link
            href="/about"
            className="text-xs text-zinc-500 hover:text-rose-700 dark:hover:text-rose-400"
          >
            了解新功能 →
          </Link>
        </div>
